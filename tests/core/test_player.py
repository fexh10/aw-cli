...
def mock_config(monkeypatch):
    ...
    monkeypatch.setattr(player.config, "data", config_dict)
    return config_dict

def test_open_player_android(monkeypatch, mock_config):
    mock_config["player"]["type"] = "android"
...
def test_open_mpv_linux_success(monkeypatch, mock_config):
    monkeypatch.setattr(env, "os_name", "Linux")
